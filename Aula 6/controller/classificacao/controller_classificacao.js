    ...
    try {
        ...
        if(resultBuscarID.status){
            ...
            if(result){
                ...
                return message.SUCESS_DELETE_ITEM //200 (Registro excluído)
            }else{
                return message.ERROR_INTERNAL_SERVER_MODEL //500 (Model)
            }
        }else{
...
const validarDados = async function(classificacao){
    ...
    if(classificacao.nome == undefined || classificacao.nome == '' || classificacao.nome == null || classificacao.nome.length > 80){
        ...
        return message.ERROR_BAD_REQUEST //400
    }else if(classificacao.descricao == undefined || classificacao.descricao == '' || classificacao.descricao == null ||  classificacao.descricao.length < 80){
